...
DT_waves = [t.t02_1, t.t04_1, t.t13_1, t.t24_1] # D0, G0, F, G2

KT = [kernels.K2200, kernels.K2211, kernels.K2220] # S0, P, S2
DT = [kernels.K2202, kernels.K2204, kernels.K2213, kernels.K2224] # D0, G0, F, G2
...
y_ReggeHI = np.array(list(map(lambda s: Regge.Ret22(s**2), x1)))
