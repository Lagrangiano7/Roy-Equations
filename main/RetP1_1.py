...
eps=1e-6
wave_ord = np.delete(t.waves_1, 3)
K_ord = kernels.getP1()
STP1 = lambda s: kernels.ST_P1(s, kernels.a00_1_t, kernels.a20_1_t)
...
def ReT11(s):
    ...
    return STP1(s) + total_diag + total_rest
...
y_ReggeHI = np.array(list(map(lambda s: reader.getWave("P1")(s**2), x1)))
