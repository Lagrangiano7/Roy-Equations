...
# b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2
par=12.2,-0.9,15.9,-5.7,-22.5,6.9,0.996,0.025,5.25,-4.4,0.175,-0.28,-5.4,10.3
err_par=0.3,1.1,2.7,3.1,3.7,4.8,0,0,0.28,0.16,0.155,0.06,3.7,4
...
def Delta(b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0):
    return (derD(b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3)/derW) + 4*d0

def c4(s):
    return 8*s**4 - 8*s**2 + 1

def delta2(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0):
    return delta11(sm,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3) + Delta(b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0)*(c1(w2(s))+1) + d0*(c2(w2(s))-1)

def deltaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0):
    if s<sm:
        return delta11(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3)
    else:
        return delta2(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0)    
...
def eta2(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2):
    return np.exp(-(eps0(b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3) + eps1(b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3)*Q(s) + eps2*Q(s)**2)**2)

def etaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2):
    if s<sm:
        return eta11(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3)
    else:
        return eta2(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2).real

def tf(s,params):
    b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2=params
    return (etaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2)*c.exp(np.pi*1j*deltaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0)/90)-1)/(2j*sigma(s,mpi))

def deltaf2(s,params):
    b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2=params
    return deltaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0)

def etaf2(s,params):
    b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2=params
    return etaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2)
