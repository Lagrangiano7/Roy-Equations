...
N=1
# b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2,eps3,eps4
par=12.2,-1.2,15.5,-6.0,-21.4,6.3,0.996,0.025,4.97,-4.72,-0.04,-0.31,-16.5,160.8,-715.5,937.3
err_par=0.3,0.8,1.5,1.5,1.3,4.5,0,0,0.08,0.08,0.18,0.04,6.2,2.4,8.5,25
...
def tf(s,params):
    b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0,eps2,eps3,eps4=params
    return (etaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,eps2,eps3,eps4)*c.exp(np.pi*1j*deltaf(s,b0,b1,b2,b3,b4,b5,rsp,isp,k0,k1,k2,k3,d0)/90)-1)/(2j*sigma(s,mpi))
