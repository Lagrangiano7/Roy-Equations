...
err_par=5*0.02536488,5*0.03,2.3*0.76206727,0.0149,0.0300,0.0008,0.16606857,0.05120559,0.02911255,0.1278119,0.21928738,0.35763276
par=12.44380344,  10.25430501,   7.37214035,   0.27325037,        0.96974787,1.2754, -12.17792683,  -1.93694783,  -3.01749573,         0.12396023,   3.63248837,  -4.44558125
...
def tf1(s,b0,b1,b1h,eps,r):
    return (etaf1(s,eps,r)*c.exp(np.pi*1j*deltaf1(s,b0,b1,b1h)/90)-1)/(2j*sigma(s,mpi))
